...
describe("Aggregator Tests", function () {
  before(async function () {
    this.aggregator = await deploy("Aggregator");
  });
  ...
  describe("Validate Aggregator", function () {
    ...
    it("Should submit a callback with the expected Aux Data", async function () {
      verifData = {
        commPc:
          "0x0181e2039220200d0e0a0100030000000000000000000000000000000000000000000000000000",
        sizePc: 0x20000000,
      };
      incProof = {
        proofSubtree: {
      ...
      await expect(this.aggregator.complete(1, 1234, 4321, incProof, verifData))
        .to.emit(this.aggregator, "CompleteAggregatorRequest")
        .withArgs(1, 1234);
    ...
    it("Should return all dealIDs created by the aggregator", async function () {
      ...
      await expect(this.aggregator.complete(1, 2222, 4321, incProof, verifData))
        .to.emit(this.aggregator, "CompleteAggregatorRequest")
        .withArgs(1, 2222);
      const allDeals = await this.aggregator.getAllDeals(
        "0x0181e2039220203f46bc645b07a3ea2c04f066f939ddf7e269dd77671f9e1e61a3a3797e665127"
      );
    ...
    it("Should return all the input cid's active dealIds", async function () {
      const activeDeals = await this.aggregator.getActiveDeals(
        "0x0181e2039220203f46bc645b07a3ea2c04f066f939ddf7e269dd77671f9e1e61a3a3797e665127"
      );
    ...
    it("Should return all the deals' dealIds if they are expiring within a certain input epoch", async function () {
      const expiringDeals = await this.aggregator.getExpiringDeals(
        "0x0181e2039220203f46bc645b07a3ea2c04f066f939ddf7e269dd77671f9e1e61a3a3797e665127",
        1000
      );
